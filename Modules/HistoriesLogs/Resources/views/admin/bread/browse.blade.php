            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        {{-- enable/disable histories logs --}}
                     
                        <div class="history-log-button">
                            <form action="{{ route('voyager.historylog.turn') }}" class="cmd_form" method="POST">
                                {{ csrf_field() }}
                                <ul class="radio">
                                    <li>
                                        <input type="radio" id="turn_on" name="cors_value" value="1"
                                        @if($activeHistory == 1) ? checked : '' @endif>
                                        <label for="turn_on">ON</label>
                                        <div class="check"></div>
                                    </li>
                                    <li>
                                        <input type="radio" id="turn_off" name="cors_value" value="0"
                                        @if($activeHistory == 0) ? checked : '' @endif>
                        ...
                        {{-- END enable/disable histories logs --}}
...
@endif
<link href="{{ mix('modules/historieslogs/css/admin.css') }}" rel="stylesheet" type="text/css">
@stop
