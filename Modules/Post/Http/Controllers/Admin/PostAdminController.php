...
class PostAdminController extends BaseVoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        ->with([
            'message'    => __('generic.successfully_updated')." {$dataType->getTranslatedAttribute('display_name_singular')}",
            'alert-type' => 'success',
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        ->route("voyager.{$dataType->slug}.index")
        ->with([
                'message'    => __('generic.successfully_added_new')." {$dataType->getTranslatedAttribute('display_name_singular')}",
                'alert-type' => 'success',
            ]);
    }
