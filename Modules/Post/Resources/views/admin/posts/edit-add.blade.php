                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @php
                                $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                                $exclude = ['title', 'body', 'excerpt', 'slug', 'status', 'category_id', 'author_id', 'published_date', 'featured', 'image', 'meta_description', 'meta_keywords', 'seo_title'];
                            @endphp
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                    <label for="published_date">{{ __('post.published_date') }}</label>
                                    <input type="date" class="form-control" name="published_date"
                                    placeholder="{{ $dataTypeContent->display_name }}"
                                    value="@if(!isset($dataTypeContent->published_date)){{ \Carbon\Carbon::parse($dataTypeContent->published_date)->format('Y-m-d') }}@else{{$dataTypeContent->published_date}}@endif">
                                </div>
                                <div class="form-group">
